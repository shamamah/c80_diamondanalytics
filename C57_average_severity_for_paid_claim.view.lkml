    ...
    derived_table: {
      sql:
        SELECT   Age
                ...
                ,exp_paid
                ,exp_paid_AllIn
        FROM OPENQUERY([C2MSSQL1], 'EXEC Diamond.dbo.assp_C57_Looker_AverageSeverityForPaidClaim @start_date = '{% parameter start_date %}', @end_date = '{% parameter start_date %}' WITH RESULT SETS ((
                                             Age integer
