  ...
  derived_table: {
    sql: SELECT cc.claimcontrol_id
      ...
      (
            ...
            WHERE ct2.claimtransactioncategory_id IN (13)  /*reserve changes 1=Loss, 3=AO, 13=DCC*/
